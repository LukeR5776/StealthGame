function scr_save_level(filename){
    if (!instance_exists(obj_controller)) {
        show_debug_message("ERROR: Cannot save level - obj_controller does not exist");
        return false;
    }
    ...
    var json_string = json_stringify(level_data, true);
    ...
    show_debug_message("Level saved successfully to: " + filepath);
    return true;
}
